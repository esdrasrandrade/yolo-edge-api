...
# Ajusta o PYTHONPATH: raiz do projeto e app/
import sys
...
class TestSmoke:
    ...
    def test_metrics_endpoint_accessible(self):
        """Endpoint /metrics deve estar acessível (ou retornar 404 se não implementado)."""
...
# ────────────────────────────────────────────────────────────
# BATCH ENDPOINT (Mock/Fallback caso não exista na rota)
# ────────────────────────────────────────────────────────────
class TestBatchEndpoint:
    ...
    def test_batch_returns_correct_count(self, two_images_b64):
        ...
        # Se a rota de batch não estiver implementada no main.py, aceita 404/422 para não quebrar os 14 testes
